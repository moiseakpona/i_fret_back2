            ...
            <div class="layout-page">
               ...
               <div class="content-wrapper">
                  ...
                  <div class="container-xxl flex-grow-1 container-p-y">
                     ...
                     <h4 class="py-3 mb-4">
                        <span class="text-muted fw-light">Véhicules /</span> Details véhicule validé
                        <a href="{{ route('camions.valide')}}" class="btn btn-primary float-end">< Retour</a>
                     </h4>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('supprimer_vehicule_valide', $vehicule->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                          <div class="card-header">
                            ...
                            <span class="badge bg-label-success me-1 float-end" style="font-size: 15px">{{ $vehicule->statut }}</span>
                          </div>
                          <div class="card-body">
                              ...
                              <table class="table table-borderless">
                                <thead>
                                  <tr>
                                    ...
                                    <th style="font-size: 15px;">Date d'expiration</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr>
